...
class GcnSummaryHistoryHandler(BaseHandler):
    @auth_or_token
    def post(self):
        """
        ---
        ...
        with self.Session() as session:
            ...
            #     GcnSummaryHistory.select(self.current_user))
            ...
            schema = GcnSummaryHistory.__schema__()
            ...
            self.push_all(action="skyportal/REFRESH_SUMMARYS")
            return self.success(data={"id": GcnSummaryHistory.dateobs})
